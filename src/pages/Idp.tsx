  ...
  const ayudantias = [
    {
      ...
      description: formatDescription(
         "Ayudante Factor Humano\n123 horas mensuales, 4 bloques de cátedra semanales\nCrear y corregir tareas, apoyar en el análisis de interacciones entre personas y productos, realizar simulaciones de diseño centradas en el usuario."
      ),
    },
  ];
